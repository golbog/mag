...
if __name__ == '__main__':
    ...
    if args.weights:
        ...
        vae.save_weights('./vae_mlp_mnist-2latent.h5')

    _, _, z = encoder.predict(x_test, batch_size=batch_size)
    x_test_pred_cont = decoder.predict(z, batch_size=batch_size)
    ...
    print(cheauder_utils.devectorize_smile(x_test[0], chars))
    print(cheauder_utils.devectorize_smile(x_test_pred[0], chars))
